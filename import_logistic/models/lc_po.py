...
class PurchaseOrder(models.Model):
    ...
    s_for = fields.Selection([('local','LOCAL'),('import','IMPORT')],string="Select For",required=True,default='local',
    ...
    lc_account = fields.Many2one('account.account', string='LC Account',readonly=True,states={'draft':[('readonly',False)]})
